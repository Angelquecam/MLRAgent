        ...
        addButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                try {
                    ...
                    myAgent.res(Double.parseDouble(value1ToPredict), Double.parseDouble(value2ToPredict));
                    fieldValue1.setText("");
                    fieldValue2.setText("");
                }
                catch (Exception e) {
                    JOptionPane.showMessageDialog(guis.this, "Invalid values. "+e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        p = new JPanel();
